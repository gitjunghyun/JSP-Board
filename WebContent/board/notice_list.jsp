...
<script type="text/javascript">
	function list() {
		document.listFrm.action = "main.jsp?pagefile=./board/notice_list";
...
<%=pagePerBlock%>
	* (value - 1) + 1;
	...
	function read(idx) {
		...
		document.readFrm.pagefile.value = "./board/read3";
...
<body>
	...
	%>
	<input type="button"
		onClick="javascript:location.href='main.jsp?pagefile=./board/post3'"
		value="글쓰기">
	<%
		} else {
	%>
	<input type="button" onClick="check_admin()" value="글쓰기">
	<%
 	}
 	}
 %>
 ...
 %></a></li>
	...
	<form name="searchFrm" method="post"
		action="main.jsp?pagefile=./board/notice_list">
	...
	<form name="readFrm" method="get">
		<input type="hidden" name="pagefile" value="./board/notice_list">
