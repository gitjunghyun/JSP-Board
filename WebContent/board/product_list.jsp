...
<script type="text/javascript">
	function list() {
		document.listFrm.action = "main.jsp?pagefile=./board/product_list";
...
<%=pagePerBlock%>
	* (value - 1) + 1;
	...
	function read(idx) {
		...
		document.readFrm.pagefile.value = "./board/read1";
...
<body>
	...
	%>
	<input type="button"
		onClick="javascript:location.href='main.jsp?pagefile=./board/post1'"
		value="글쓰기">
	<%
		}
	%>
 ...
 %></a></li>
	...
	<form name="searchFrm" method="post"
		action="main.jsp?pagefile=./board/product_list">
