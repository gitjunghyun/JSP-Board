...
<script type="text/javascript">
	...
	function update(idx) {
		...
		document.updateFrm.pagefile.value = "./board/update2";
	...
	function del(idx) {
		...
		document.delFrm.pagefile.value = "./board/delete2";
...
<body>
 ...
 %>
	...
	<form name="updateFrm" method="get">
		<input type="hidden" name="pagefile" value="./baord/update2"> <input
			type="hidden" name="idx" value="<%=idx%>"> <input
			type="hidden" name="nowPage" value="<%=nowPage%>">
	</form>
	...
	<form name="delFrm" method="get">
		<input type="hidden" name="pagefile" value="./baord/delete2"> <input
			type="hidden" name="idx" value="<%=idx%>"> <input
			type="hidden" name="nowPage" value="<%=nowPage%>">
	</form>
</body>
