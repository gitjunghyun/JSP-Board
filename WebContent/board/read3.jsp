...
<script type="text/javascript">
	...
	function update(idx) {
		...
		document.updateFrm.pagefile.value = "./board/update3";
	...
	function del(idx) {
		...
		document.delFrm.pagefile.value = "./board/delete3";
...
<body>
 ...
 %>
	...
	<form name="listFrm" method="post">
		<input type="hidden" name="pagefile" value="./board/notice_list"> <input
	...
	<form name="updateFrm" method="get">
		<input type="hidden" name="pagefile" value="./baord/update3"> <input
			type="hidden" name="idx" value="<%=idx%>"> <input
			type="hidden" name="nowPage" value="<%=nowPage%>">
	</form>
	...
	<form name="delFrm" method="get">
		<input type="hidden" name="pagefile" value="./baord/delete3"> <input
			type="hidden" name="idx" value="<%=idx%>"> <input
			type="hidden" name="nowPage" value="<%=nowPage%>">
	</form>
</body>
